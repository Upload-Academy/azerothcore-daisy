...
@questdescription := "I got them weird magic chickens poppin' up all over me farm! They jus' keep comin' an' comin'. Lots o' folks been tryin' to kill 'em, but they don't stay dead. Can ya help thin 'em out a bit 'til we figger how to stop 'em for good?
",
@areadescription := "",
@questcompletionlog := "Quest complete
",
@requirednpcorgo1 := 500100,
@requirednpcorgo2 := 500101,
@requirednpcorgo3 := 0,
@requirednpcorgo4 := 0,
