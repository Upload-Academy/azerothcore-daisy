def sql_new_creaturefamily_dbc(data, path):
    with open(path, 'r') as fd:
        return fd.read().format(
            id = data['id'],
            minscale = data['minscale'],
            minscalelevel = data['minscalelevel'],
            maxscale = data['maxscale'],
            maxscalelevel = data['maxscalelevel'],
            skillline_1 = data['skillline_1'],
            skillline_2 = data['skillline_2'],
            petfoodmask = data['petfoodmask'],
            pettalenttype = data['pettalenttype'],
            categoryenumid = data['categoryenumid'],
