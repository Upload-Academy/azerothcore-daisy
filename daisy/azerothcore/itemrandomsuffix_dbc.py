def sql_new_itemrandomsuffix_dbc(data, path):
    with open(path, 'r') as fd:
        return fd.read().format(
            ...
            enchantment_1 = data['enchantment_1'],
            enchantment_2 = data['enchantment_2'],
            enchantment_3 = data['enchantment_3'],
            enchantment_4 = data['enchantment_4'],
            enchantment_5 = data['enchantment_5'],
            allocationpct_1 = data['allocationpct_1'],
            allocationpct_2 = data['allocationpct_2'],
            allocationpct_3 = data['allocationpct_3'],
            allocationpct_4 = data['allocationpct_4'],
            allocationpct_5 = data['allocationpct_5'],
        )